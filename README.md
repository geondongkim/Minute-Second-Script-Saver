...
Microsoft Teams 라이브 캡션과 Vimeo 강의 자막을 캡처, 저장하고 Gemini 또는 OpenAI로 회의/강의 내용을 요약하는 Chrome/Edge Manifest V3 확장입니다.
...
| `chrome.storage.local` | 최근 세션 인덱스, 세션별 캡션 청크, 참석자 보고서, Vimeo 수집 상태/자막, 뷰어 전달 데이터, 마지막 AI 요약 |

최근 세션 히스토리는 최대 10개를 기준으로 관리됩니다.
Vimeo 세션 히스토리는 최대 20개를 기준으로 관리되며 같은 URL은 최신 수집 결과로 교체됩니다.
...
브라우저에서 확장을 새로고침한 뒤 Teams 페이지와 Vimeo 강의 페이지에서 팝업, 사이드 패널, 뷰어, 저장, 수집 중단/재수집 흐름을 확인합니다.
...
- 팝업과 사이드 패널의 Vimeo UI/AI 요약 기능을 동일하게 맞췄습니다.
- 뷰어 히스토리에서 Teams 세션과 Vimeo 강의 세션을 함께 열 수 있습니다.
